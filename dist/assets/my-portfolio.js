...
;define("my-portfolio/components/button", ["exports", "@ember/component", "@ember/template-factory", "@ember/component/template-only"], function (_exports, _component, _templateFactory, _templateOnly) {
        ...
        {{#if @isDark}}
          ...
          >
            <MdIcon
              ...
              @size='20'
              class='h-5 w-5 -mt-0.5 sm:mt-0.5 ml-0 sm:ml-0.5 text-yellow-500'
            />
          </button>
        {{else}}
          <button
          ...
          >
            <MdIcon
              ...
              @size='20'
              class='h-5 w-5 -mt-0.5 sm:mt-0.5 ml-0 sm:ml-0.5 text-black'
            />
          </button>
        {{/if}}
      </div>
  ...
  */
  {
    "id": "EHECRkFf",
    "block": "[[[10,0],[14,0,\"flex flex-row items-center space-x-2 text-sm absolute top-20 left-1/3 sm:left-2/3\"],[12],[1,\"\\n\\n  \"],[10,0],[15,0,[29,[[52,[30,1],\"text-[#9c9ea3]\"]]]],[12],[1,\"Change theme to:\"],[13],[1,\"\\n\\n  \"],[10,0],[14,0,\"w-10 h-4 flex items-center bg-gray-300 rounded-full\"],[12],[1,\"\\n    \"],[10,0],[15,0,[29,[\"md:w-6 md:h-6 h-5 w-5 rounded-full bg-myblue shadow-md transform\\n        \",[52,[30,1],\"translate-x-5\"]]]],[12],[1,\"\\n\"],[41,[30,1],[[[1,\"        \"],[11,\"button\"],[24,\"data-test-theme-toggle\",\"\"],[24,4,\"button\"],[4,[38,1],[\"click\",[30,2]],null],[12],[1,\"\\n          \"],[8,[39,2],[[24,\"data-test-theme-icon\",\"\"],[24,0,\"h-5 w-5 -mt-0.5 sm:mt-0.5 ml-0 sm:ml-0.5 text-yellow-500\"]],[[\"@icon\",\"@size\"],[\"white-balance-sunny\",\"20\"]],null],[1,\"\\n        \"],[13],[1,\"\\n\"]],[]],[[[1,\"        \"],[11,\"button\"],[24,\"data-test-theme-toggle\",\"\"],[24,4,\"button\"],[4,[38,1],[\"click\",[30,2]],null],[12],[1,\"\\n          \"],[8,[39,2],[[24,\"data-test-theme-icon\",\"\"],[24,0,\"h-5 w-5 -mt-0.5 sm:mt-0.5 ml-0 sm:ml-0.5 text-black\"]],[[\"@icon\",\"@size\"],[\"moon-waxing-crescent\",\"20\"]],null],[1,\"\\n        \"],[13],[1,\"\\n\"]],[]]],[1,\"    \"],[13],[1,\"\\n  \"],[13],[1,\"\\n\"],[13]],[\"@isDark\",\"@toggleTheme\"],false,[\"if\",\"on\",\"md-icon\"]]",
...
;define("my-portfolio/components/info", ["exports", "@ember/component", "@ember/template-factory", "@ember/component/template-only"], function (_exports, _component, _templateFactory, _templateOnly) {
  ...
  /*
    ...
    <div class='-mt-6'>
      ...
      <div
        class='flex flex-row flex-wrap -mt-8 w-60 h-40 bg-myblue rounded-2xl mb-10 justift-center'
      >
        <h1
          data-test-info-name
          class='text-2xl font-heboo font-extrabold ml-14 pt-12 bg-transparent
            {{if @isDark "text-white"}}'
        >
          {{@data.fullName}}
        </h1>
        <h3 class='text-white bg-transparent text-sm ml-16 -mt-7'>
          {{@data.description}}
        </h3>
      </div>
    </div>
    <div class='flex flex-col space-y-2 ml-6'>
      <div class='text-myblue font-bold mb-6'> How to reach me: </div>
      ...
      <a
        ...
        class='{{if @isDark "text-red-100" "text-mygrey"}}
          underline text-sm hover:text-green-300'
      >
        {{@data.website}}
      </a>
      ...
      <div
        class='{{if @isDark "text-blue-100" "text-mygrey"}}
          text-sm underline hover:text-yellow-600'
      >
...
;
          if (!runningTests) {
            require("my-portfolio/app")["default"].create({"name":"my-portfolio","version":"0.0.0+0853cd0f"});
          }
